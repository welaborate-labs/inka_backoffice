...
Product.create!(
  [
    { name: "some product name_1", sku: "SKU01", unit: "kilograma" },
    { name: "some product name_2", sku: "SKU02", unit: "kilograma" },
    { name: "some product name_3", sku: "SKU03", unit: "kilograma" },
    { name: "some product name_4", sku: "SKU04", unit: "litro" },
    { name: "some product name_5", sku: "SKU05", unit: "litro" },
    { name: "product_6", sku: "PR06SK", unit: "kilograma" }
  ]
)
