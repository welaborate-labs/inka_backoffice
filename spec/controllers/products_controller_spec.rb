    ...
    context "when authenticated" do
      context "with valid parameters" do
        it "creates a new product" do
          expect { post :create, params: { product: valid_attributes } }.to change(Product, :count).by(01)
        end
      ...
      context "with invalid parameters" do
        ...
        it "does not create a new product" do
          expect { post :create, params: { product: invalid_attributes } }.to change(Product, :count).by(0)
        end
