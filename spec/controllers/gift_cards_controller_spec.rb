...
RSpec.describe GiftCardsController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: gift_card.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      gift_card = GiftCard.create! valid_attributes
      get :edit, params: {id: gift_card.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new GiftCard" do
        expect {
          post :create, params: {gift_card: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {gift_card: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested gift_card" do
        gift_card = GiftCard.create! valid_attributes
        put :update, params: {id: gift_card.to_param, gift_card: new_attributes}, session: valid_session
        gift_card.reload
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        gift_card = GiftCard.create! valid_attributes
        put :update, params: {id: gift_card.to_param, gift_card: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested gift_card" do
      gift_card = GiftCard.create! valid_attributes
      expect {
        delete :destroy, params: {id: gift_card.to_param}, session: valid_session
      }.to change(GiftCard, :count).by(-1)
    end
