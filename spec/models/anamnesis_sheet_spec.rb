...
RSpec.describe AnamnesisSheet, type: :model do
  ...
  let(:invalid) { build(:anamnesis_sheet, customer_id: nil) }
  ...
  describe "validations" do
    context "presence" do
      ...
      context "invalid attributes" do
        ...
        it { expect(invalid.errors.attribute_names).to eq %i[customer] }
        it { expect(invalid.errors.messages.count).to eq 1 }
