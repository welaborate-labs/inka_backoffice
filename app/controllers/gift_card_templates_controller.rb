class GiftCardTemplatesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @gift_card_template.save
        format.html { redirect_to gift_card_template_url(@gift_card_template), notice: "Gift card template was successfully created." }
  ...
  def update
    respond_to do |format|
      if @gift_card_template.update(gift_card_template_params)
        format.html { redirect_to gift_card_template_url(@gift_card_template), notice: "Gift card template was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to gift_card_templates_url, notice: "Gift card template was successfully destroyed." }
  ...
  private
    ...
    def gift_card_template_params
      params.require(:gift_card_template).permit(
        :title,
        :description,
        :price,
        :inline_items,
