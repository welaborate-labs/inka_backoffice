class GiftCardsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @gift_card.save
        format.html { redirect_to gift_card_url(@gift_card), notice: "Vale Presente criado com sucesso." }
  ...
  def update
    respond_to do |format|
      if @gift_card.update(gift_card_params)
        format.html { redirect_to gift_card_url(@gift_card), notice: "Vale Presente atualizado com sucesso." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to gift_cards_url, notice: "Vale Presente removido com sucesso." }
  ...
  private
    ...
    def gift_card_params
      params.require(:gift_card).permit(:customer_id, :gift_card_template_id, :bill_id, :price, :name, :uuid, { service_ids: [] } )
    end
end
